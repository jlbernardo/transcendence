  ...
  return (
    <div className="w-full h-full border-4  border-black bg-black/70">
      ...
      <div className="flex">
        ...
        <p className="text-gray-400 ml-3">Ma ~ (mgonzaga)</p>
      </div>
      <div className="flex">
        <div className="w-2 h-2 bg-amber-400 rounded-full ml-3 mt-2"></div>
        <p className="text-gray-400 ml-3">Sabriiiina (sabrferr)</p>
      </div>
      <div className="flex">
        <div className="w-2 h-2 bg-green-500 rounded-full ml-3 mt-2"></div>
        <p className="text-gray-400 ml-3">Natali Rocha (namoreir)</p>
      </div>
      ...
      <div className="flex">
        ...
        <p className="text-gray-400 ml-3">Juba (julberna)</p>
      </div>
      ...
      <div className="flex">
        <p className="text-gray-400 ml-3">0xEDU (etachott)</p>
