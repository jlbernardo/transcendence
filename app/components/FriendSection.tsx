  ...
  return (
    <div className="w-full h-full border-4  border-black bg-black/70">
      <div>
        ...
        <FriendList friends={friends.filter(friend => friend.is_online === true)} status="online" />
      </div>
      ...
      <div>
        ...
        <FriendList friends={friends.filter(friend => friend.is_online === false)} status="offline" />
      </div>
